...
function Sbc() {
  return (
    <div className='w-full px-[2%] my-[2%] hidden navmid:block'>
        <div className="border-t-[1px] pt-[5%] flex flex-col items-center justify-center">
            <div className='text-center text-[150%] mb-[3%]'>
                 SHOP BY CATEGORY
            </div>
            <div className='flex flex-row w-full items-center justify-between'>
                {items.map(i=>{
                    return (
                        <div className='w-[18%]  last:mr-[0%] first:ml-[0%] flex flex-col' key={i.name}>
                            <NavLink to={'/store/'+i.to} style={{backgroundImage:`url(${i.img})`}}  className=' w-[100%] imgBack pb-[130%]'>
                            </NavLink>
