...
function HeaderBottom() {
  return (
    <>
    <div className='hidden phone:flex flex-row px-[2%] ms:px-[5%]  shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px]'>
        ...
        <div className='w-[33.3%] pb-[1%] flex items-center justify-center '>
          ...
          <div className='flex flex-col w-[40%]'>
            ...
            <div className='text-[80%] hidden ms:block'>Free Shiping on all us order or 200$ order</div>
          </div>
        </div>
